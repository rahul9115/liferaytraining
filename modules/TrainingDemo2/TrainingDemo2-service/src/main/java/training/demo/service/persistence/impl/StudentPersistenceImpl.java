...
package training.demo.service.persistence.impl;
...
import training.demo.exception.NoSuchStudentException;
import training.demo.model.Student;
import training.demo.model.StudentTable;
import training.demo.model.impl.StudentImpl;
import training.demo.model.impl.StudentModelImpl;
import training.demo.service.persistence.StudentPersistence;
import training.demo.service.persistence.StudentUtil;
import training.demo.service.persistence.impl.constants.TrainingDemoPersistenceConstants;
...
public class StudentPersistenceImpl
	...
	@Override
	@Reference(
		target = TrainingDemoPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = TrainingDemoPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
